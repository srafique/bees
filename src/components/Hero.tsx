      ...
      <Container className="flex flex-wrap ">
        ...
        <div className="flex items-center w-full lg:w-1/2 lg:order-first">
          ...
          <h3 className="text-lg font-semibold leading-snug tracking-tight text-gray-800 lg:text-xl lg:leading-snug xl:text-2xl xl:leading-snug dark:text-white">
              Safe & Humane Bee Removal Services
            </h3>

            <h3 className="text-lg font-semibold leading-snug tracking-tight text-gray-800 lg:text-xl lg:leading-snug xl:text-2xl xl:leading-snug dark:text-white">
              Protect Your Home & The Bees
            </h3>

            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              Are bees swarming around your home or business? Don’t risk painful stings or property damage—our expert 
              bee removal services provide safe, effective, and eco-friendly solutions. We relocate bees responsibly, 
              ensuring they thrive in a safer environment while keeping your space bee-free.
            </p>
            ...
            {/* <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              <a
                ...
                target="_blank"
                rel="noopener"
                className="px-8 py-4 text-lg font-medium text-center text-white bg-[#b38600] rounded-md ">
                Download for Free
              </a>
              <a
      ...
      {/* <Container>
        <div className="flex flex-col justify-center">
          <div className="text-xl text-center text-gray-700 dark:text-white">
            Trusted by <span className="text-[#b38600]">2000+</span>{" "}
            customers worldwide
          </div>
